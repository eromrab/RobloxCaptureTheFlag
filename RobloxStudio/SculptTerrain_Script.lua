...
local BASE_MIN_HEIGHT = 5 -- Base areas: minimum height (studs above baseplate top)
local BASE_MAX_HEIGHT = 40 -- Base areas: maximum height
local DEFEND_MIN_HEIGHT = 5 -- Defend areas: minimum height
local DEFEND_MAX_HEIGHT = 80 -- Defend areas: maximum height
local NEUTRAL_MIN_HEIGHT = 5 -- Neutral area: minimum height
