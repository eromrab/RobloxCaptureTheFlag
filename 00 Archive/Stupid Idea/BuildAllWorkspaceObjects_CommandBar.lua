-- COMMAND BAR SCRIPT: Builds ALL workspace objects from exported files
-- Paste this ENTIRE script into Roblox Studio Command Bar (View > Command Bar)
-- This will recreate all objects in the correct order

local workspace = game:GetService("Workspace")

print("=== Building All Workspace Objects ===")
print("")
...
print("\nStep 4: Creating Spawn Locations...")
