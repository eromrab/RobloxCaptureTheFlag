-- Creates TeamBMidpointZoneWall if it doesn't already exist
local wallName = "TeamBMidpointZoneWall"
...
if not existingWall then
	...
	-- Position: Adjust this X value to where you want Team B's zone to start
	-- Currently set to X=558, creating a neutral zone from TeamAMidpointZoneWall to here
	part.Position = Vector3.new(558, 70.5, 84)
	part.Anchored = true
	...
	part.Color = Color3.new(0.051, 0.412, 0.675) -- Team B blue (same as Team A for now)
