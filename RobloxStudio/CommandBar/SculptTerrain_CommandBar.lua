...
local DEFEND_MIN_HEIGHT = 30 -- Defend areas: minimum height (must be at least 10 studs above baseplate top)
...
-- Store spawn location relative positions BEFORE terrain generation
...
-- Adjust spawn locations to sit on top of sculpted terrain (preserving relative positions)
print("\n📍 Adjusting spawn locations to sculpted terrain (preserving relative positions)...")
